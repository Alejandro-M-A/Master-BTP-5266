CLASS zcl_upload_data_script_5266 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_upload_data_script_5266 IMPLEMENTATION.
...
*last_changed_at       : abp_lastchange_tstmpl;
    ...
    data: lt_acc_categ type table of ztacccateg_log,
          lt_catego    type table of ztbcateg_log,
          lt_clientes  type table of ztclientes_log,
          lt_clnts_lib type table of ztclnt_lib_log,
          lt_libros    type table of ztlibros_log.
...
******** TABLA1 ********
    ...
    delete from ztb_acc_cat_5266.
    insert ztb_acc_cat_5266 from table @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_5266.
    insert ztb_catego_5266 from table @lt_catego.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_client_5266.
    insert ztb_client_5266 from table @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    delete from ztb_cln_lib_5266.
    insert ztb_cln_lib_5266 from table @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_5266.
    insert ztb_libros_5266 from table @lt_libros.
