...
CLASS zcl_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA: lt_travel   TYPE TABLE OF ztb_travel_m_555,
          lt_booking  TYPE TABLE OF ztb_bookng_m_555,
          lt_book_sup TYPE TABLE OF ztb_booksp_m_555.
    ...
    TABLE @lt_book_sup.
    DELETE FROM: ztb_travel_m_555,
    ztb_bookng_m_555,
    ztb_booksp_m_555.
    INSERT:
    ztb_travel_m_555 FROM TABLE @lt_travel,
    ztb_bookng_m_555 FROM TABLE @lt_booking,
    ztb_booksp_m_555 FROM TABLE @lt_book_sup.
    out->write( sy-dbcnt ).
    out->write( 'DONE!' ).
  ENDMETHOD.
ENDCLASS.
